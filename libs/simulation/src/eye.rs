...
impl Eye{
    ...
    pub fn process_vision_see_chasers(&self, position: &na::Point2<f32>, rotation: &na::Rotation2<f32>, chasers: &[Chaser]) -> Vec<f32> {
    ...
    pub fn process_vision_see_plants(&self, position: &na::Point2<f32>, rotation: &na::Rotation2<f32>, plants: &[Plant]) -> Vec<f32> {
        let mut cells = vec![0.0; self.cells];
    ...
    pub fn process_vision_see_hervors(&self, position: &na::Point2<f32>, rotation: &na::Rotation2<f32>, hervors: &[Hervor]) -> Vec<f32> {
        let mut cells = vec![0.0; self.cells];
